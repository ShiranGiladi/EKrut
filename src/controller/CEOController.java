...
/**
 * This class is the "home page" of the user "CEO" (employee).
 * The CEO can go from the window that this class represents to the window: show reports (to see the reports that the system generates).
 * The CEO can also log out and get back to the "welcome to E-Krut - login" window, or exit the system altogether.
 */
public class CEOController {
    ...
    /**
	 * This method logs out the user (CEO) from the system.
	 * Once the user clicks on the "logout" button, the current window, "CEO", will close, and instead, the window 
    ...
    /**
     * This method closes the current window ("CEO") and opens the window "Show Reports".
     * @param event
     * @throws IOException
     */
    @FXML
    void getViewReportsbtn(ActionEvent event) throws IOException {
    	((Node)event.getSource()).getScene().getWindow().hide();
